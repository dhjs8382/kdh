        ...
        if client is None:
            ...
            with st.spinner("🔄 Gemini AI가 주택 사진을 정밀 분석 중입니다..."):
                try:
                    ...
                    prompt = f"""
                    당신은 국내 최정상급 건축공학 및 도시재생 전문가입니다. 첨부된 노후 주택 사진과 해당 건물이 위치한 지역의 GIS 공공데이터 정보를 종합 분석하여 [주거환경 개선 맞춤형 가이드 리포트]를 마크다운 형식으로 작성해 주세요.
                    ...
                    친절하면서도 신뢰감 있는 전문적인 한글 뉘앙스로 작성해 주세요.
                    """
